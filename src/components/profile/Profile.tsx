...
const items = [
  {
    ...
    header: <Image src={JosumaruProfile} alt='Josumaru' className='rounded-lg h-full object-cover fill-neutral-50 grayscale hover:grayscale-0 duration-300' />,
  ...
  },
  {
    ...
    description: 'This jutsu has suddenly become unusable since I entered this world.',
    header: <div className='flex max-md:h-[200px] items-center text-sm justify-center text-primary-500 h-full'>_next/image?url=/_next/static/media can&apos;t be resolved</div>,
    className: 'md:col-span-2',
