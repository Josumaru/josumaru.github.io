...
const Header: NextPage = ({}) => {
  return (
    <div className="h-[50rem] w-full dark:bg-black bg-white  dark:bg-grid-small-white/[0.2] bg-grid-small-black/[0.2] relative flex items-center justify-center flex-col">
      ...
      <div className="z-50">
        <div className="relative inline-flex h-8 overflow-hidden rounded-full p-[1px] focus:outline-none focus:ring-2 focus:ring-rose-400 focus:ring-offset-2 focus:ring-offset-rose-500 my-5">
          ...
          <span className="inline-flex h-full w-full items-center justify-center rounded-full bg-jwhite px-3 py-1 text-sm font-medium text-white backdrop-blur-3xl bg-white">
            <p className="inline animate-gradient bg-gradient-to-r from-rose-300 via-rose-600 to-rose-300 bg-[length:var(--bg-size)_100%] bg-clip-text text-transparent">
              Software Engineer
            </p>
          </span>
        </div>
      ...
      <div className="flex sm:flex-col md:flex-row gap-2 w-full items-center justify-center my-5">
        <button className="group flex items-center justify-center gap-2 border border-rose-500 bg-rose-500 hover:bg-rose-600 p-2 rounded-xl sm:w-full md:w-96 text-xl font-medium text-white">
          <p>Connect </p>
          <ArrowRight className="group-hover:ml-4 duration-300" />
        </button>
        <button className="bg-rose-100 p-2 rounded-xl sm:w-full md:w-96 text-xl border border-rose-300 font-medium text-black">
          GitHub
        </button>
      </div>
    </div>
