...
const Header: NextPage = ({}) => {
  return (
    <div
      id="home"
      className="h-[50rem] w-full dark:bg-grid-small-white/[0.2] bg-grid-small-black/[0.2] relative flex items-center justify-center flex-col"
    >
      ...
      <div className="flex px-2 md:flex-row gap-2 w-full items-center justify-center my-5">
        <Link target="_blank" href="https://github.com/Josumaru/">
          <Button className="group flex max-sm:flex-1 h-12 hover:shadow-xl hover:shadow-primary-500/75  duration-500 items-center justify-center gap-1 border border-primary-500 bg-primary-500 hover:bg-primary-600 p-2 rounded-2xl sm:w-full md:w-96 text-sm md:text-md font-medium text-white">
        ...
        <Link target="_blank" href="https://github.com/Josumaru/">
          <Button className="bg-primary-100 max-sm:flex-1 dark:bg-neutral-800 h-12 rounded-2xl sm:w-full md:w-96 text-sm md:text-md border border-primary-300 dark:border-neutral-700 hover:dark:border-neutral-600 dark:hover:bg-neutral-800 dark:hover:shadow-none font-medium text-primary-500 dark:text-white hover:bg-primary-200/90 hover:shadow-xl hover:shadow-primary-500/20 duration-500">
